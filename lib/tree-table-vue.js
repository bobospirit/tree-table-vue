      ...
      if (this.table.treeType && this.table.firstProp === column.key) {
        if (column.type === 'template') {
          return h(
            ...
            }), this.table.$scopedSlots[column.template] ? this.table.$scopedSlots[column.template]({ row: row, rowIndex: rowIndex, column: column, columnIndex: columnIndex }) : '']
          );
        }
        return h(
          'span',
